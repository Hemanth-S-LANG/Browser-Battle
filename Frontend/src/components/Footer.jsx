        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-2">
              {socialLinks.map((s, i) => (
                <a key={i} href={s.href}
                  className="w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold t-b hover:text-orange-400 transition-all"
          ...
          <div>
            ...
            <ul className="space-y-2">
              {quickLinks.map(link => (
                <li key={link.path}>
                  <Link to={link.path} className="text-sm t-m hover:text-orange-400 transition-colors flex items-center gap-2 group">
